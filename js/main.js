...
contactButton.addEventListener("click", () => {
    const subject = encodeURIComponent("Mensaje importante");
    const body = encodeURIComponent("Hola, estoy interesado en tus servicios...");

    window.location.href = `mailto:humanogiselle@gmail.com?subject=${subject}&body=${body}`;
});
